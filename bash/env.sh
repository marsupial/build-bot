...
export CFLAGS="-I$BOT_ROOT/include $CFLAGS"
export CPPFLAGS="-I$BOT_ROOT/include $CPPFLAGS"
export CXXFLAGS="-I$BOT_ROOT/include $CXXFLAGS"
export LDFLAGS="-L$BOT_ROOT/lib $LDFLAGS"
